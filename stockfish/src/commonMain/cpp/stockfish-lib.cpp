...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass clazz = jenv->FindClass("com/nwagu/stockfish/StockfishService");
    if (clazz == 0) {
        LOGE("class com/nwagu/stockfish/StockfishService not found");
    }
...
JNIEXPORT void JNICALL Java_com_nwagu_stockfish_StockfishService_clientToEngine(JNIEnv *env,
                                                                                      jobject thiz,
                                                                                      jstring line) {
